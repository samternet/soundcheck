...
/**
 * The logo mark: beamed music notes. Used everywhere the brand appears (login,
 * sidebar, loading screen, sidebar footer) so the mark stays consistent.
 */
export { Music as LogoIcon } from 'lucide-react'
